...
**Status:** ✅ **Complete** — archived OpenSpec change `2026-08-16-dungeon-baseline-changeset`.
**Disposition:** **DELETE.** Baseline loading, changeset diffing and the read-only track-web path
are all specific to the Gherkin handoff bundle.

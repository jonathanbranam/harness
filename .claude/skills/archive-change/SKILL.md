...
1. **Select the change**
   ...
   Always announce: "Using change: <name>" and how to override (e.g., `/archive-change <other>`).
...
- If sync is requested, run the `sync-specs` workflow inline (agent-driven)

// Defense-in-depth for the built-in bash/write/edit tools, mirroring
// deck-harness-server's permission-gate.ts:
...
// isolated approval queue instead of sharing one module-level Map.
